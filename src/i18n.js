export function getTranslations(isSpanish) {
  return {
    ...
    myProfile: isSpanish ? 'Mi perfil' : 'My Profile',
    firstNameLabel: isSpanish ? 'Nombre' : 'First name',
    lastNameLabel: isSpanish ? 'Apellido' : 'Last name',
    birthDateLabel: isSpanish ? 'Fecha de nacimiento' : 'Birth date',
    sexLabel: isSpanish ? 'Sexo' : 'Sex',
    selectOption: isSpanish ? 'Seleccionar' : 'Select',
    sexFemale: isSpanish ? 'Femenino' : 'Female',
    sexMale: isSpanish ? 'Masculino' : 'Male',
    sexNonBinary: isSpanish ? 'No binario' : 'Non-binary',
    sexPreferNotSay: isSpanish ? 'Prefiero no decirlo' : 'Prefer not to say',
    youtubeAccount: isSpanish ? 'Cuenta de YouTube' : 'YouTube account',
    connectYouTube: isSpanish ? 'Conectar YouTube' : 'Connect YouTube',
    ...
    profileSaveFailed: isSpanish ? 'No se pudo guardar el perfil.' : 'Could not save profile.',
    ...
    // Photo area
    dragDropPhotos: isSpanish ? 'Arrastra y suelta fotos o videos aqui' : 'Drag & drop photos or videos here',
    ...
    uploadingPhotos: (d, t) => isSpanish ? `Subiendo ${d} de ${t} archivos...` : `Uploading ${d} of ${t} files...`,
    ...
    createPresentation: isSpanish ? 'Create Presentation' : 'Create Presentation',
    loadingPresentation: isSpanish ? 'Cargando presentacion...' : 'Loading presentation...',
    presentationTitle: (name) => isSpanish ? `Presentacion de ${name}` : `${name} presentation`,
    downloadPresentation: isSpanish ? 'Descargar video' : 'Download video',
    shareVideo: isSpanish ? 'Compartir video' : 'Share video',
    shareOnSocial: isSpanish ? 'Compartir en' : 'Share on',
    sharePresentationText: (name) => isSpanish ? `Mira esta presentacion de ${name}` : `Watch this ${name} presentation`,
    presentationShareFailed: isSpanish ? 'No se pudo crear el link publico de la presentacion.' : 'Could not create the public presentation link.',
    sharedPresentation: isSpanish ? 'Presentacion compartida' : 'Shared presentation',
    exportingPresentation: isSpanish ? 'Preparando video...' : 'Preparing video...',
    presentationExportProgress: (done, total) => isSpanish ? `Exportando ${done}/${total}` : `Exporting ${done}/${total}`,
    videoExportUnsupported: isSpanish ? 'Tu navegador no soporta exportar video desde esta presentacion.' : 'Your browser does not support video export from this presentation.',
    videoExportFailed: isSpanish ? 'No se pudo exportar el video. Intenta con menos fotos o con otro navegador.' : 'Could not export the video. Try fewer photos or another browser.',
    videoShareUnsupported: isSpanish ? 'Tu navegador no soporta compartir este video directamente.' : 'Your browser does not support sharing this video directly.',
    videoShareFailed: isSpanish ? 'No se pudo compartir el video. Intenta con menos fotos o desde un celular.' : 'Could not share the video. Try fewer photos or share from a mobile device.',
    pausePresentation: isSpanish ? 'Pausar' : 'Pause',
    playPresentation: isSpanish ? 'Reproducir' : 'Play',
